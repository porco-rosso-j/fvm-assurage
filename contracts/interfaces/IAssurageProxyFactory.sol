...
interface IAssurageProxyFactory is IDefaultImplementationBeacon {
     ...
     *  @param AssurageGlobal_ The address of a Assurage Globals contract.
     */
    event AssurageGlobalSet(address indexed AssurageGlobal_);
    ...
    /**
     *  @dev The address of the AssurageGlobal contract.
     */
    function AssurageGlobal() external view returns (address AssurageGlobal_);
    ...
    /**
     *  @dev   Sets the Assurage Globals contract.
     *         Only the Governor can call this function.
     *  @param AssurageGlobal_ The address of a Assurage Globals contract.
     */
    function setGlobal(address AssurageGlobal_) external;
